...
"DGCBTNOREFOCUSPERSPECTIVE",
"VGZUVBALANCEPOINTBFOUBKBA"
].map(r => r.split(""));

const WORDS_OPTION_2 = new Set([
"ALIGNMENT","INTUITION","INSIGHT","CENTERED","PRESENCE","TRANSPARENCY","RENEWAL","COHERENCE","SYNERGY","MOMENTUM","RHYTHM","PURITY","REFINEMENT","ADAPTABILITY","STABILITY","OPENNESS","ELEVATION","DEPTH","VITALITY","PRECISION","MODERATION","FLUIDITY","INTEGRATION","LIGHTNESS","EXPANSION","AUTHENTICITY","AWAKENING","RESET","HARMONIZE","GROUNDING","RECENTER","NAVIGATE","THOUGHTFUL","FORWARD","MINIMAL","CLEARVIEW","INTENTFUL","GUIDING","STEADY","FLOWING","DIRECTED","REFOCUS","UNITY","BALANCEPOINT","ESSENCE","PERSPECTIVE","PATH","SIMPLICITY","BALANCE","POINT"
]);
